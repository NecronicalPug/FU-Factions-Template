...
#define ammo_rifle_grom "30Rnd_65x39_caseless_mag"
...
class PAF_Leader_GROM_m : PAF_base_m_B_GROM_temp                             
      ...
      weapons[] = {"arifle_MXC_ACO_pointer_snds_F","FU_pistol_b","Throw","Put","Rangefinder"};                                   
...
class PAF_RiflemanLAT_GROM_m : PAF_base_m_B_GROM_temp                             
      ...
      icon = "iconManLeader";                                         
      scope = 2;                                                      
      DisplayName = "GROM Rifleman (LAT)";
      linkedItems[] = {"rhsusf_spcs_ocp_rifleman","rhsusf_mich_bare_norotos_tan","ItemCompass","ItemMap","TFAR_anprc152","ItemWatch","ACE_NVG_Wide"};    
      weapons[] = {"arifle_MXC_ACO_pointer_snds_F","FU_pistol_b","launch_MRAWS_sand_rail_F","Throw","Put","Rangefinder"};                                   
      magazines[] = {mags_2(ammo_pistol_b),mags_7(ammo_rifle_grom),mags_2(HandGrenade),mags_2(SmokeShell)};                                                                  
...
class _fu_smoke {name = "SmokeShell";count = 4;};
class _fu_csmoke {name = "SmokeShellPurple";count = 2;};
class PAF_attachment1 {name = "optic_Hamr";count=1;};
	                     };
};
...
class PAF_attachment1 {name = "optic_Hamr";count=1;}; //Items added to backpack, Items class must be unique for adding new items, cannot exceed backpack storage
	                     };
      };
